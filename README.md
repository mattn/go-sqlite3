...
| Disable Serialization | sqlite_omit_deserialize | Serialization and deserialization of a SQLite database is available by default.<br><br>To disable it add the build tag `sqlite_omit_deserialize`. |
