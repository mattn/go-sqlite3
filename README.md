...
[![GoDoc Reference](https://godoc.org/github.com/stetsyk2/go-sqlite3?status.svg)](http://godoc.org/github.com/stetsyk2/go-sqlite3)
[![GitHub Actions](https://github.com/stetsyk2/go-sqlite3/workflows/Go/badge.svg)](https://github.com/stetsyk2/go-sqlite3/actions?query=workflow%3AGo)
[![Financial Contributors on Open Collective](https://opencollective.com/mattn-go-sqlite3/all/badge.svg?label=financial+contributors)](https://opencollective.com/mattn-go-sqlite3) 
[![codecov](https://codecov.io/gh/mattn/go-sqlite3/branch/master/graph/badge.svg)](https://codecov.io/gh/mattn/go-sqlite3)
[![Go Report Card](https://goreportcard.com/badge/github.com/stetsyk2/go-sqlite3)](https://goreportcard.com/report/github.com/stetsyk2/go-sqlite3)
...
This package can be installed with the `go get` command:
    ...
    go get github.com/stetsyk2/go-sqlite3

_go-sqlite3_ is *cgo* package.
If you want to build your app using go-sqlite3, you need gcc.
However, after you have built and installed _go-sqlite3_ with `go install github.com/stetsyk2/go-sqlite3` (which requires gcc), you can build your app without relying on gcc in future.

***Important: because this is a `CGO` enabled package, you are required to set the environment variable `CGO_ENABLED=1` and have a `gcc` compile present within your path.***

# API Reference

API documentation can be found [here](http://godoc.org/github.com/stetsyk2/go-sqlite3).
...
For more information see [#201](https://github.com/stetsyk2/go-sqlite3/issues/201)
...
- [#242](https://github.com/stetsyk2/go-sqlite3/issues/242)
- [#504](https://github.com/stetsyk2/go-sqlite3/issues/504)
...
Additional information:
- [#206](https://github.com/stetsyk2/go-sqlite3/issues/206)
- [#404](https://github.com/stetsyk2/go-sqlite3/issues/404)
...
- Compile error: `can not be used when making a shared object; recompile with -fPIC`
    ...
    More details see [#120](https://github.com/stetsyk2/go-sqlite3/issues/120)

- Can't build go-sqlite3 on windows 64bit.

    > Probably, you are using go 1.0, go1.0 has a problem when it comes to compiling/linking on windows 64bit.
    > See: [#27](https://github.com/stetsyk2/go-sqlite3/issues/27)

- `go get github.com/stetsyk2/go-sqlite3` throws compilation error.
    ...
    ```bash
    go install github.com/stetsyk2/go-sqlite3
    ```
...
- Getting insert error while query is opened.
    ...
    > See: [#39](https://github.com/stetsyk2/go-sqlite3/issues/39)

- Do you want to cross compile? mingw on Linux or Mac?

    > See: [#106](https://github.com/stetsyk2/go-sqlite3/issues/106)
...
- Can I use this in multiple routines concurrently?
    ...
    Yes for readonly. But not for writable. See [#50](https://github.com/stetsyk2/go-sqlite3/issues/50), [#51](https://github.com/stetsyk2/go-sqlite3/issues/51), [#209](https://github.com/stetsyk2/go-sqlite3/issues/209), [#274](https://github.com/stetsyk2/go-sqlite3/issues/274).
...
- Why I'm getting `no such table` error?
    ...
    * [#204](https://github.com/stetsyk2/go-sqlite3/issues/204)
    * [#511](https://github.com/stetsyk2/go-sqlite3/issues/511)
...
- Reading from database with large amount of goroutines fails on OSX.
    ...
    For more information, see [#289](https://github.com/stetsyk2/go-sqlite3/issues/289)
...
- Trying to execute a `.` (dot) command throws an error.
    ...
    More information see [#305](https://github.com/stetsyk2/go-sqlite3/issues/305).
...
- Error: `database is locked`
    ...
    For more information, see [#209](https://github.com/stetsyk2/go-sqlite3/issues/209).
...
<a href="https://github.com/stetsyk2/go-sqlite3/graphs/contributors"><img src="https://opencollective.com/mattn-go-sqlite3/contributors.svg?width=890&button=false" /></a>
